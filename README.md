...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uvyg53e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uvyg53e.containers.anotherwebservice.com/
...
```
git clone git@github.com:EngDawood/container-uvyg53e.git
cd container-uvyg53e
```
...
```
docker attach container-uvyg53e
```
